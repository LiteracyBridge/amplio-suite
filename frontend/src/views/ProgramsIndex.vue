<template>
  <main class="container mx-auto text-center">
    ...
    <div v-else class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 pb-16">
      ...
      >
        ...
        <h3 class="py-4" v-if="showProgramIds">
          <span class="font-bold">{{ programName(programId) }}</span
          ><br />
    ...
    <div class="text-left text-sm text-gray-500">
      <v-tooltip
        text="The Program ID is used by Amplio support personnel, but is not needed for most functions."
      >
...
export default {
  ...
  computed: {
    ...mapState(useProgramsStore, ["status", "programs", "programNames"]),
