<template>
  <main class="container mx-auto">
    ...
    <div class="mb-4 pb-4 rounded-md shadow-box">
      <header
        class="p-4 text-white text-xl text-center font-bold uppercase bg-amplio-green rounded-t-md"
      >
        <h2>Launch checklist</h2>
      </header>

      <div class="p-6 bg-white">
        <steps :options="generalOptions" :selected="roadmap" :on-click="toggleStep" />

        <p class="text-amplio-green text-xl text-center font-bold">READY TO LAUNCH</p>

        <steps :options="launchOptions" :selected="roadmap" :on-click="toggleStep" />
      </div>
    </div>
  </main>
</template>
