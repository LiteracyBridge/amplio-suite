  ...
  <main class="container mx-auto pt-4 text-center">
    ...
    <div class="mx-auto pt-20" style="max-width: 300px">
      ...
      <p class="text-sm mt-4">
        ...
        <router-link class="text-amplio-green font-bold" to="/login">Sign in</router-link>
      </p>
    </div>
  </main>
</template>
    ...
    async handleRegister() {
      try {
        ...
        this.setNotification({
          type: "notice",
          text: "Check your email and copy the validation code",
        });
        ...
        if (error === "Not fill") {
          ...
          this.setNotification({
            type: "alert",
            text:
              "The email address provided does not match our records in the system. Please contact support@amplio.org",
          });
        } else {
          this.setNotification({ type: "alert", text: error.message });
        }
