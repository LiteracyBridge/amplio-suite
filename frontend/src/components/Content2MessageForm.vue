<template>
  ...
  >
    ...
    <multiselect
      ...
      @select="
        (opt) => setMessageSDGGoal({ deployment, playlist, message, goal: opt.goalId })
      "
    ...
    <multiselect
      ...
      @select="
        (opt) =>
          setMessageSDGTarget({ deployment, playlist, message, target: opt.targetId })
      "
      @remove="
        (opt) => setMessageSDGTarget({ deployment, playlist, message, target: null })
      "
    >
      <template slot="option" slot-scope="props">
        <span
    ...
    <textarea
      ...
      @input="
        (event) =>
          setMessageKeyPoints({ deployment, playlist, message, text: event.target.value })
      "
    >
    </textarea>
    ...
    <multiselect
      ...
      @remove="
        (format) => setMessageFormat({ deployment, playlist, message, format: null })
      "
    />
